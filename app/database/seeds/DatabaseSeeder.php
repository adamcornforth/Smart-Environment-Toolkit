...
class LightHeatSeeder extends Seeder {
    ...
    public function run()
    {
        ...
        $spots['vitali'][] = Spot::create(array('spot_address' => '0014.4F01.0000.0001', 'user_id' => 3)); // Vitali
        $spots['vitali'][] = Spot::create(array('spot_address' => '0014.4F01.0000.0002', 'user_id' => 3));
         ...
         * Create some Jobs
         */
        $jobs['door_open'] = Job::create(array('title' => 'Door open', 'object_id' => $objects['fridge']->id, 'sensor_id' => $sensors['accelerometer']->id, 'threshold' => 300));
        $jobs['kettle_boiled'] = Job::create(array('title' => 'Kettle boiled', 'object_id' => $objects['kettle']->id, 'sensor_id' => $sensors['thermometer']->id, 'threshold' => 70));
        $jobs['chair_moved'] = Job::create(array('title' => 'Chair moved', 'object_id' => $objects['chair']->id, 'sensor_id' => $sensors['accelerometer']->id, 'threshold' => 300));
        ...
        while($carbon->lt($now)) {
                ...
                $kettle_boiled = (mt_rand(0,300) == 1) ? 100-mt_rand(1,5)+$random_float : 31-mt_rand(1,5)+$random_float;
